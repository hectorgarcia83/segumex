<div class="footer">
	...
	<div class="row">
		<div class="small-5 medium-12 large-10 small-centered medium-centered large-centered columns redessociales">
			<div class="small-6 medium-2 medium-offset-1 columns text-center">
				<div class="icon-red">
			...
			<div class="small-6 medium-2 columns end text-center">
				<div class="icon-red">
	...
	<div class="link-inicio">
		<div class="row">
			<div class="small-3 columns small-centered text-center flecha-inicio">
				<a href="javascript:goToSection(0)">
					<img src="media/images/flecha_arriba_inicio_footer.png" alt="">
				</a>
			</div>
		</div>
		<div class="row">
